...
data.raw["utility-constants"].default.turret_range_visualization_color = {r = 0.1, g = 0.1, b = 0.3, a = .15}
...
data.raw["utility-constants"].default.capsule_range_visualization_color= {r = 0.1, g = 0.1, b = 0.3, a = 0.15}
...
data.raw["utility-sprites"].default.logistic_radius_visualization.tint = {r = 0.5, g = 0, b = 0.5}
...
data.raw["utility-sprites"].default.construction_radius_visualization.tint = {r = 0, g = 0.5, b = 0.5}
